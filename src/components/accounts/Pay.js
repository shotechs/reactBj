...
function Pay({ user, setUser, setLoggedInStatus }) {
          ...
          <div className="row row-cols-1 row-cols-md-2 g-4">
            <div className="col-md-3">
              <div className="card  border-dark">
                ...
                <div className="card-header">$10 Coins</div>
                <div className="card-body">
            ...
            <div className="col-md-3">
              <div className="card  border-dark">
                {/* <img src="..." className="card-img-top" alt="..." /> */}
                <div className="card-header">$20 Coins</div>
                <div className="card-body">
            ...
            <div className="col-md-3">
              <div className="card  border-dark">
                {/* <img src="..." className="card-img-top" alt="..." /> */}
                <div className="card-header">$50 Coins</div>
                <div className="card-body">
